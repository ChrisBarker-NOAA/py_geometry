...
from py_geometry.cy_point_in_polygon import point_in_poly, points_in_poly
...
poly2_ccw = np.array ( ( poly1_ccw[3], #shares part of the boundary with poly1_ccw
                     poly1_ccw[4],
                     poly1_ccw[5],
                     poly1_ccw[6],
                     poly1_ccw[7],
...
#        """
#        assert point_in_poly(self.polygon_cw, np.asarray(point, dtype=np.float64))
#
#
